...
/* Test Case
* 001: Validar elementos en sign Up usando un correo electronico y eligiendo la opcion no bonus
*/
test(' 001: Validar elementos en sign Up usando un correo electronico y eligiendo la opcion no bonus @regression', async ({page, registration}) => {
    ...
    await expect(registration.noBonus).toBeVisible();
    ...
    await registration.emailRegistrationNoBonus(email,password,passwordConfirmation);
